...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOODENTRY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MOODENTRY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MOODENTRY actions', async () => {
      const arg = { id: 3183 };
    ...
    it('dispatches UPDATE_MOODENTRY actions', async () => {
      const arg = { id: 3183 };
    ...
    it('dispatches PARTIAL_UPDATE_MOODENTRY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MOODENTRY actions', async () => {
      const arg = 42666;
